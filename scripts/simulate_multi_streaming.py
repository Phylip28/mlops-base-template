...
class StreamingPayload(TypedDict):
...
def generate_random_payload(use_case_name: str) -> StreamingPayload:
...
def simulate_streaming(num_events: int = 150) -> None:
    ...
    for i in range(1, num_events + 1):
        ...
        try:
            ...
            anomaly_flag = bool(res_ingest.json().get("anomaly_flagged", False))
